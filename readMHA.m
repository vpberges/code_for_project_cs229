...
%READDICOM This program takes in a folder with .mha and reads them all.
%
%   INPUT:
%   pathMHA - String folder path name that holds .dcm's.
%
%   OUTPUT:
...
[trash, volCT, info] = evalc('ReadData3D([pathMHA filesep celDirectory(2).name]);');
[m,n,s]              = size(volCT);
